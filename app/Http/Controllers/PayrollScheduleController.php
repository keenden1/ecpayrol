...
class PayrollScheduleController extends Controller
{
    ...
    {
        // Get detailed attendance records for DTR display
        $detailedAttendance = ProcessedAttendance::where('employee_id', $employeeId)
            ->whereBetween('attendance_date', [$startDate, $endDate])
            ->orderBy('attendance_date', 'asc')
            ->get();

        // Get summary statistics
        $summary = ProcessedAttendance::where('employee_id', $employeeId)
            ->whereBetween('attendance_date', [$startDate, $endDate])
            ->selectRaw('
