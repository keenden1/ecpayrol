...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/payroll/dashboard', [\App\Http\Controllers\Dashboard\PayrollDashboardController::class, 'index'])
        ->name('payroll.dashboard');

    Route::get('/finance/dashboard', [\App\Http\Controllers\Dashboard\FinanceDashboardController::class, 'index'])
        ->name('finance.dashboard');

    Route::get('/employee/dashboard', [\App\Http\Controllers\Dashboard\EmployeeDashboardController::class, 'index'])
        ->name('employee.dashboard');

    Route::get('/manager/dashboard', [\App\Http\Controllers\Dashboard\ManagerDashboardController::class, 'index'])
...
|--------------------------------------------------------------------------
*/
Route::middleware(['auth', 'verified', 'role:hrd_manager,superadmin,payroll_officer'])
    ->prefix('employees')
    ->group(function () {
...
|--------------------------------------------------------------------------
*/
Route::middleware(['auth', 'verified', 'role:hrd_manager,superadmin,payroll_officer'])->group(function () {
    ...
    */
    ...
    Route::get('/biometric-devices/sync-progress', [BiometricController::class, 'getSyncProgress'])
        ->name('biometric-devices.sync-progress');
    Route::get('/biometric-devices/sync-history', [BiometricController::class, 'getSyncHistory'])
    ...
    Route::post('/attendance/bulk-update', [ProcessedAttendanceController::class, 'bulkUpdate'])
